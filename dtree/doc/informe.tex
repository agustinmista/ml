...
\begin{figure}
  \centering
  \subfloat[][Entrenamiento]{\includegraphics[width=0.5\textwidth]{../datasets/spiral/{spiral150.data}.png}}
  \subfloat[][Predicción]{\includegraphics[width=0.5\textwidth]{../datasets/spiral/{spiral150.prediction}.png}}
  \caption*{\textbf{n=150}}

  \centering
  \subfloat[][Entrenamiento]{\includegraphics[width=0.5\textwidth]{../datasets/spiral/{spiral600.data}.png}}
  \subfloat[][Predicción]{\includegraphics[width=0.5\textwidth]{../datasets/spiral/{spiral600.prediction}.png}}
  \caption*{\textbf{n=600}}

  \centering
  \subfloat[][Entrenamiento]{\includegraphics[width=0.5\textwidth]{../datasets/spiral/{spiral3000.data}.png}}
  \subfloat[][Predicción]{\includegraphics[width=0.5\textwidth]{../datasets/spiral/{spiral3000.prediction}.png}}
