...
\begin{figure}
  \centering
  \subfloat[][Before prunning]{\includegraphics[width=0.5\textwidth]{error_before_prunning.png}}
  \subfloat[][After prunning]{\includegraphics[width=0.5\textwidth]{error_after_prunning.png}}
  \caption*{\textbf{blah blah}}

  \centering
  \subfloat[][Before prunning]{\includegraphics[width=0.5\textwidth]{size_before_prunning.png}}
  \subfloat[][After prunning]{\includegraphics[width=0.5\textwidth]{size_after_prunning.png}}
  \caption*{\textbf{blah blah}}
